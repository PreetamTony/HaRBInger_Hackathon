...
login_email = login_form.text_input("Enter your email:")
login_password = login_form.text_input("Enter your password:", type='password')
...
# Sign Up Form
signup_form = st.sidebar.form("signup_form")
signup_email = signup_form.text_input("Enter new email:")
signup_password = signup_form.text_input("Enter new password:", type='password')
...
if 'user_email' in locals() or 'user_email' in globals():
